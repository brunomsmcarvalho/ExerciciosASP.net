...
namespace Exercicio11ASP.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public EnrollmentsController(DbSchoolContext context)
        {
            _context = context;
        }
        ...
        {
            var dbSchoolContext = _context.Enrollments.Include(e => e.Course).Include(e => e.Student);
            return View(await dbSchoolContext.ToListAsync());
        }
